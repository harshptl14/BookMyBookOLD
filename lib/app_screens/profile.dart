import 'package:bookmybook/app_screens/displayproduct/categories2.dart';
import 'package:bookmybook/app_screens/first_screen.dart';
import 'package:bookmybook/app_screens/initialPages/auth.dart';
import 'package:bookmybook/app_screens/initialPages/auth_provider.dart';
...
//      Firestore.instance.collection(college).document("department").collection("computer").document("EtACFkJ92NxKs4UjcZo3").delete().catchError((e){
//        print(e);
//      });
//     //qn = await firestore.collection("cspit").getDocuments();
