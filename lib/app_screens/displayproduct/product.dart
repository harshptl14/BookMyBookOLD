  ...
  Widget build(BuildContext context) {
    ...
    Widget image_carousel = new Container(
        ...
        child: prefix0.Carousel(
          ...
          images: [
            Image.network(
              '${widget.computer.data["image"]}' + '?alt=media'
            ),
          ],
          autoplay: false,
          ...
          SliverFixedExtentList(
              delegate: SliverChildListDelegate([
                Container(
                  ...
                  child: ListTile(
                    title: Text(widget.computer.data["title"],
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 22,
                          fontFamily: 'Montserrat',
                        )),
                    trailing: Text(widget.computer.data["price"].toString(),
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 25,
                          fontFamily: 'Montserrat',
                        )),
                    subtitle: Text(widget.computer.data["author"],
                        style: TextStyle(
                          fontFamily: 'Montserrat',
                        )),
                  ),
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(widget.computer.data["about"],
                        style: TextStyle(
                          fontFamily: 'Montserrat',
                        )),
                  ),
                ...
                Container(
                  ...
                  height: 70,
                  child: ListTile(
                    leading: Image ( height: 55,
                                width: 55,
                      image: AssetImage('depimages/user.png')),
                    title: Text(widget.computer.data["username"],
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 15,
                          fontFamily: 'Montserrat',
                        )),
                    subtitle: Text(widget.computer.data["number"].toString(),
                        style: TextStyle(
                          fontFamily: 'Montserrat',
                        )),
                  ),
                        ...
                        Container(
                          padding: EdgeInsets.only(left:25),
                            ...
                            child: Row(children: <Widget>[
                              ...
                              Icon(Icons.swap_horizontal_circle,size: 30,color: Colors.grey,),
                       ...
                       Container(
                          padding: EdgeInsets.only(left:35),
                            ...
                            child: Row(children: <Widget>[
                              ...
                              Icon(Icons.monetization_on,size: 30,color: Colors.grey,),
              ...
              children: <Widget>[
                Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: (){
                        Map[widget.computer.data["title"].toString()] = widget.computer.data["price"];
                        putdata();
                        toast();
